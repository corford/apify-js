...
const request_queue_1 = require("../request_queue"); // eslint-disable-line import/named,no-unused-vars
...
async function enqueueLinksByClickingElements(options = {}) {
    ...
    utils_1.checkParamOrThrow(transformRequestFunction, 'transformRequestFunction', 'Function');
    utils_1.checkParamOrThrow(waitForPageIdleSecs, 'waitForPageIdleSecs', 'Number');
    utils_1.checkParamOrThrow(maxWaitForPageIdleSecs, 'maxWaitForPageIdleSecs', 'Number');
