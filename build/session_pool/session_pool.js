...
class SessionPool extends events_1.EventEmitter {
     ...
     */
    constructor(options = {}) {
        const { maxPoolSize = 1000, persistStateKeyValueStoreId = null, persistStateKey = 'SESSION_POOL_STATE', createSessionFunction = null, sessionOptions = {}, log = utils_log_1.default, } = options;
        super();
        // Validation
        utils_1.checkParamOrThrow(maxPoolSize, 'options.maxPoolSize', 'Number');
        utils_1.checkParamOrThrow(sessionOptions, 'options.sessionOptions', 'Object');
        utils_1.checkParamOrThrow(persistStateKeyValueStoreId, 'options.persistStateKeyValueStoreId', 'Maybe String');
        utils_1.checkParamOrThrow(persistStateKey, 'options.persistStateKey', 'String');
        utils_1.checkParamOrThrow(createSessionFunction, 'options.createSessionFunction', 'Maybe Function');
